...
function back() {
    ...
    if (key2 === 'Admin') {
        ...
        url1 ="C:/Users/pcit106/Desktop/Dharmik/Day5/Admin/adminhome.html";
        window.location.href = `${url1}?key1=${key1}`;
    } else if (key2 === 'User'){
       
        const url2 = "C:/Users/pcit106/Desktop/Dharmik/Day5/home/home.html";
        window.location.href = `${url2}?key1=${key1}`;
    }
